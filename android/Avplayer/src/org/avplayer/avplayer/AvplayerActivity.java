...
public class AvplayerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(filename == null)
		{
			...
			//test rtmp live
			//filename = "file://rtmp://192.168.12.201/live/stream123 live=1";
			//test rtmp vod
			//filename = "file://rtmp://192.168.12.201/vod/stream123";
		}
		...
		if(filename != null){
			...
			if(filename.indexOf(".torrent") >=0){
				...
				else if(is_url.equals("rtmp://")){
					
					m_res = AvplayerNative.AvplayOpen(filename, MEDIA_TYPE_RTMP, RENDER_ANDROID_OGL);
				}
				else{
